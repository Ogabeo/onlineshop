# Generated by Django 4.2.11 on 2024-04-19 13:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(default='default/category.jpg', upload_to='icons/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('None', 'None'), ('New', 'New'), ('Hot', 'Hot'), ('Best', 'Best Sale'), ('Sale', 'Sale')], default='New', max_length=50)),
