...
from .views import HomePageView, DetailReviewView, CategoryProductsView, ContactView, BrandProducts, DetailView, ShopAllView, ShopCategoryView, CategoryProductsView
